<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item ">
        <a class="{{Request::segment(1)=='dashboard'?'nav-link':'nav-link collapsed'}}" href="{{route('dashboard.home')}}">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="{{Request::segment(1)=='customer'?'nav-link':'nav-link collapsed'}}" href="{{route('customer.home')}}">
