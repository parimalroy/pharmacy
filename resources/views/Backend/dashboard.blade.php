        ...
        <div class="card-body pb-0">
          ...
          <div class="news">
            <div class="post-item clearfix">
              <img src="{{url('/img/news-1.jpg')}}" alt="" />
            ...
            <div class="post-item clearfix">
              <img src="{{url('/img/news-2.jpg')}}" alt="" />
            ...
            <div class="post-item clearfix">
              <img src="{{url('/img/news-3.jpg')}}" alt="" />
              <h4>
                <a href="#"
            ...
            <div class="post-item clearfix">
              <img src="{{url('/img/news-4.jpg')}}" alt="" />
            ...
            <div class="post-item clearfix">
              <img src="{{url('/img/news-5.jpg')}}" alt="" />
              <h4>
